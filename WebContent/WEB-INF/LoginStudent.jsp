			...
			<div class="container mt-5 mx-auto w-50">
				<div class="card shadow">
					...
					<form action="LoginStudentController" method="POST">
						<div class="col-auto">
							<div class="mb-auto">
								<label for="Uname" class="form-label" name="name">Email</label> <input type="text"
									class="form-control" name="email" id="Uname">
							</div>
							<div class="mb-auto">
						...
						<a href="StudentRegistration.jsp"  id="Rme" style="margin-left: 10%;">Don't have account?</a>
						<a href="ConfirmEmail.jsp" target="_blank" style="text-align: right; float: right; margin-right: 10%;">Forgot my password?</a>
						<br><br>
						<div class="center">
