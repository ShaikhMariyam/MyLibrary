			...
			<div class="card shadow">
				<div class="card-header text-center bg-white border-0">
					<h1>Forgot Password</h1>
										...
										<form action="SecurityQuestionsA.jsp">
				
					<div class="card-body ">
					
						<h5 class="card-title">Enter Your Email</h5>
						<p class="card-text">
							<input type="text" name="email" placeholder="email@graduate.utm.my"
								required>
						</p>
					...
					<div class="card-footer text-center bg-white border-0">
						<input type="submit" value ="Confirm" class="btn btn-warning btn-lg" name="check" id="register"><br>
